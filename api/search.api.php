...
if (isset($_REQUEST['q'])) {
    ...
    $sql = "SELECT books.book, text.chapter, text.verse, text.text  FROM kjv.text LEFT JOIN books ON text.book=books.id WHERE MATCH (`text`) AGAINST (\"".$search_q."\" IN NATURAL LANGUAGE MODE) LIMIT 16;";
